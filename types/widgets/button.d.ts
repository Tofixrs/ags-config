...
declare const AgsButton_base: {
    new (...args: any[]): {
        ...
        connections: import("./widget.js").Connection<Gtk.Button>[];
        binds: import("./widget.js").Bind[];
        properties: import("./widget.js").Property[];
        connectTo<GObject extends import("@girs/gobject-2.0").GObject.Object>(gobject: GObject, callback: (self: Gtk.Button, ...args: any[]) => void, signal?: string | undefined): any;
        attribute: any;
...
export default class AgsButton extends AgsButton_base {
    ...
    get on_clicked(): (self: AgsButton) => void;
