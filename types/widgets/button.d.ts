...
declare const AgsButton_base: {
    new (...args: any[]): {
        ...
        custom_tag_start(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null): [boolean, import("@girs/glib-2.0").GLib.MarkupParser, any];
        ...
        vfunc_custom_tag_start(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null): [boolean, import("@girs/glib-2.0").GLib.MarkupParser, any];
