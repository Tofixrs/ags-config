...
declare const AgsMenu_base: {
    new (...args: any[]): {
        ...
        connections: import("./widget.js").Connection<Gtk.Menu>[];
        binds: import("./widget.js").Bind[];
        properties: import("./widget.js").Property[];
        connectTo<GObject extends import("@girs/gobject-2.0").GObject.Object>(gobject: GObject, callback: (self: Gtk.Menu, ...args: any[]) => void, signal?: string | undefined): any;
        attribute: any;
        _setPack(orientation: "h" | "v", align: "fill" | "start" | "end" | "center" | "baseline"): void;
...
export declare class AgsMenu extends AgsMenu_base {
    ...
    get on_popup(): MenuEventHandler['on_popup'];
    set on_popup(callback: MenuEventHandler['on_popup']);
    get on_move_scroll(): MenuEventHandler['on_move_scroll'];
...
declare const AgsMenuItem_base: {
    new (...args: any[]): {
        ...
        _get<T>(field: string): T;
        _set<T_1>(field: string, value: T_1, notify?: boolean): void;
        connections: import("./widget.js").Connection<Gtk.MenuItem>[];
        binds: import("./widget.js").Bind[];
        properties: import("./widget.js").Property[];
        connectTo<GObject extends import("@girs/gobject-2.0").GObject.Object>(gobject: GObject, callback: (self: Gtk.MenuItem, ...args: any[]) => void, signal?: string | undefined): any;
        attribute: any;
        _setPack(orientation: "h" | "v", align: "fill" | "start" | "end" | "center" | "baseline"): void;
        _getPack(orientation: "h" | "v"): "fill" | "start" | "end" | "center" | "baseline";
        hpack: "fill" | "start" | "end" | "center" | "baseline";
