...
declare const AgsSlider_base: {
    new (...args: any[]): {
        ...
        connections: import("./widget.js").Connection<Gtk.Scale>[];
        binds: import("./widget.js").Bind[];
        properties: import("./widget.js").Property[];
        connectTo<GObject extends import("@girs/gobject-2.0").GObject.Object>(gobject: GObject, callback: (self: Gtk.Scale, ...args: any[]) => void, signal?: string | undefined): any;
        attribute: any;
