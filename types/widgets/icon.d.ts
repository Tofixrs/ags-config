...
declare const AgsIcon_base: {
    new (...args: any[]): {
        ...
        connections: import("./widget.js").Connection<Gtk.Image>[];
        binds: import("./widget.js").Bind[];
        properties: import("./widget.js").Property[];
        connectTo<GObject extends import("@girs/gobject-2.0").GObject.Object>(gobject: GObject, callback: (self: Gtk.Image, ...args: any[]) => void, signal?: string | undefined): any;
        attribute: any;
        ...
        custom_tag_start(builder: Gtk.Builder, child: import("@girs/gobject-2.0").GObject.Object | null, tagname: string | null): [boolean, GLib.MarkupParser, any];
        ...
        vfunc_custom_tag_start(builder: Gtk.Builder, child: import("@girs/gobject-2.0").GObject.Object | null, tagname: string | null): [boolean, GLib.MarkupParser, any];
