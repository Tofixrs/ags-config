...
declare const AgsBox_base: {
    new (...args: any[]): {
        ...
        connections: import("./widget.js").Connection<Gtk.Box>[];
        binds: import("./widget.js").Bind[];
        properties: import("./widget.js").Property[];
        connectTo<GObject extends import("@girs/gobject-2.0").GObject.Object>(gobject: GObject, callback: (self: Gtk.Box, ...args: any[]) => void, signal?: string | undefined): any;
        attribute: any;
